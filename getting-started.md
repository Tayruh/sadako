...
<html>
    ...
    <body>
        <div id="output"></div>
        <code id="source" style="display:none">
            ## demo
                Hello world
                + The End
        </code>
...
The `source` code block is where you write the story. It's recommended to use a code tag so you can safely write characters normally reserved for HTML tags like `<` and `>` signs.
